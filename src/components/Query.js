...
import {  FormControl, FormLabel, RadioGroup, Radio, FormControlLabel, Grid } from '@mui/material';
...
export default function Query(props) {
    ...
    const handleInputChange = (event) => {
        event.persist();
        setVastaukset(vastaukset => ({...vastaukset,  [props.query.id]: event.target.value}));
                ...
                <FormControl component="fieldset">
                    ...
                    >
                        ...
                        props.query.answers.map(
                            (answer, index) => 
                            <FormControlLabel value={index} control={<Radio />} label={answer} onClick={handleInputChange} />
                        )
                        }
                    </RadioGroup>
                    </form>
